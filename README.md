...
- Before run this you should:
	...
	> run this on server: **$ npm run dev or npm run start**

	> run this on client: **$ yarn serve**
...
| /questions/ask                    | POST   | token:user |  title: String <br> description: String | **Success:** <br> 201: Object question <br> **Error:** <br> 500: Internal server error <br> 400: Validation error                                        |
| /questions/:id                    | GET    | none        | none                                                                                                               | **Success:** <br> 200: object question <br> **Error:** <br>  500: Internal server error                                                                   |
| /questions/user                    | GET    | none        | none                                                                                                               | **Success:** <br> 200: object question <br> **Error:** <br>  500: Internal server error                                                                   |
