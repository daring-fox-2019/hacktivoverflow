<template>
  <header>
    <nav class="navbar navbar-expand navbar-dark bg-info d-flex justify-content-between fixed-top">
      <router-link to="/">
        <div class="d-flex" style="text-decoration: none; color:black">
          <a class="navbar-brand text-black"><i class="fab fa-stack-overflow" style="color: black; text-shadow: 2px 2px 5px red"> hacktiv
            <b>overflow</b></i></a>
        </div>
      </router-link>
