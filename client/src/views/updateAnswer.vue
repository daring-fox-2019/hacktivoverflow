...
export default {
  ...
  methods: {
    ...
    getUpdateAnswer() {
      this.updateAnswer({ answerId: this.$route.params.answerId, title: this.title, description: this.answer, question: this.question, user: this.user});
    },
